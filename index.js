...
function encodeURLComponent(urlComponent) {
  const encodComponent = encodeURIComponent(urlComponent);
  return encodComponent;
...
function decodeURLComponent(urlComponent) {
  const decode = decodeURIComponent(urlComponent);
  return decode;
